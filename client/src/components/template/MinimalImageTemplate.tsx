          ...
          <div className="mt-3 space-y-2 text-sm">
            {data.personal_info.email && (
              <p className="flex items-center gap-2">
                <Mail className="w-4 h-4 text-gray-500" /> {data.personal_info.email}
              </p>
            )}
            {data.personal_info.phone && (
              <p className="flex items-center gap-2">
                <Phone className="w-4 h-4 text-gray-500" /> {data.personal_info.phone}
              </p>
            )}
            {data.personal_info.location && (
              <p className="flex items-center gap-2">
                <MapPin className="w-4 h-4 text-gray-500" /> {data.personal_info.location}
              </p>
            )}
          </div>
        </section>
